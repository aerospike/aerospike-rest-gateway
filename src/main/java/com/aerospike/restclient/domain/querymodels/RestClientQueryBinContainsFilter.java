...
public class RestClientQueryBinContainsFilter extends RestClientQueryFilter {
    @Schema(description = "TODO", required = true, allowableValues = AerospikeAPIConstants.QueryFilterTypes.CONTAINS)
    final public String filterType = AerospikeAPIConstants.QueryFilterTypes.CONTAINS;
