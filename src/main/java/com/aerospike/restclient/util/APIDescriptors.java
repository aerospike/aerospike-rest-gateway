...
public class APIDescriptors {
    ...
    public static final String BATCH_POLICY_FILTER_EXP_NOTES = "Optional expression filter. If filterExp exists and evaluates to false, the specific batch key request is not performed and RecordClientBatchRecordResponse.ResultCode is set to " +
            "FILTERED_OUT. " +
            "If exists, this filter overrides the batch parent policy filterExp " +
