...
public class ExecuteV2Tests {
    ...
    public ExecuteV2Tests(ObjectMapper mapper, ResponseDeserializer deserializer, String mt, boolean useSet) {
        objectMapper = mapper;
        ...
        if (useSet) {
            setName = "executeSet";
            testEndpoint = "/v2/execute/scan/" + namespace + "/" + setName;
        } else {
            testEndpoint = "/v2/execute/scan/" + namespace;
        }
        testKeys = setKeys();
        queryStatusEndpoint = "/v2/execute/scan/status/";
    }
