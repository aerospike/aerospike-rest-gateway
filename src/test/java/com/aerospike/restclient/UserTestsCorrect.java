...
public class UserTestsCorrect {
	...
	public void getUsers() throws Exception {
		...
		List<Map<String, Object>>UserList = handler.getUsers(mockMVC, endpoint);//objectMapper.readValue(resJson, userListType);
	...
	public void getUser() throws Exception {
		...
		Map<String, Object>userObj = handler.getUser(mockMVC, endpoint + "/" + userName);//objectMapper.readValue(resJson, userType);
	...
	private boolean userHasRoles(String username, List<String>roles) {
		...
		Set<String>searchRoles = new HashSet<String>(roles);
		Set<String>actualRoles = new HashSet<String>(user.roles);
