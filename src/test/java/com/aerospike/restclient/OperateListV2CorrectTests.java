...
public class OperateListV2CorrectTests {
    ...
    public OperateListV2CorrectTests(OperationV2Performer performer, boolean useSet) {
        ...
        if (useSet) {
            ...
            testEndpoint = ASTestUtils.buildEndpointV1("operate", "test", "junit", "listop").replace("v1", "v2");
        } else {
            testKey = new Key("test", null, "listop");
            testEndpoint = ASTestUtils.buildEndpointV1("operate", "test", "listop").replace("v1", "v2");
        }
    }
