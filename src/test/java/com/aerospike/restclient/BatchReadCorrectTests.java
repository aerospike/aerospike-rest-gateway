...
public class BatchReadCorrectTests {
	...
	private String endpoint = "/v1/batch";
	...
	public void testGetExistingRecords() throws Exception {
		List<Map<String, Object>>batchKeys = new ArrayList<Map<String, Object>>();
	...
	private Map<String, Object>keyToBatchObject(Key key, String[]bins) {
		Map<String, Object> restKey = new HashMap<String, Object>();
		Map<String, Object>batchObj = new HashMap<String, Object>();
		restKey.put("namespace", key.namespace);
		restKey.put("setName", key.setName);
		restKey.put("userKey", ((StringValue)key.userKey).toString());
		if (bins != null) {
	...
	private boolean compareRestRecordsToBatchReads(List<Map<String,Object>>returnedRecords, List<BatchRead>batchReads) {
